...
public class BlockBrauthemSolarPanel extends BlockContainer {
    ...
    public void addInformation(ItemStack stack, @org.jetbrains.annotations.Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(Localization.translate("icwth.mfsu.capacity ") + " " + String.format("%.2f", TileBrauthemSolarPanel.capacity) + (" eu"));
        tooltip.add(Localization.translate("icwth.mfsu.generate ") + " " + String.format("%.2f", TileBrauthemSolarPanel.generate) + (" eu/t"));
    }
