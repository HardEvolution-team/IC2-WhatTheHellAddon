...
public class ItemQuantumOverclocker extends Item implements IProcessingUpgrade, IUpgradeItem, IItemHudInfo {


    private final double EnergyMultiplier = 2;
    private final double ProcessTimeMultiplier = 0.15;
    ...
    public ItemQuantumOverclocker() {
        setRegistryName("quantum_overclocker");        // The unique name (within your mod) that identifies this item
        setTranslationKey(Tags.MODID + ".quantum_overclocker");     // Used for localization (en_US.lang)
    ...
    public List<String> getHudInfo(ItemStack itemStack, boolean b) {
        return Collections.singletonList("Overclocker Upgrade2"); // Информация на HUD
    }
