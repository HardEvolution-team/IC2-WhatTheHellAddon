...
public class ItemAdvancedOverclocker extends Item implements IProcessingUpgrade, IUpgradeItem, IItemHudInfo {


    private final double EnergyMultiplier = 2.5;
    private final double ProcessTimeMultiplier = 0.25;
    ...
    public ItemAdvancedOverclocker() {
        setRegistryName("advanced_overclocker");        // The unique name (within your mod) that identifies this item
        setTranslationKey(Tags.MODID + ".advanced_overclocker");     // Used for localization (en_US.lang)
    ...
    public List<String> getHudInfo(ItemStack itemStack, boolean b) {
        return Collections.singletonList("Overclocker Upgrade1"); // Информация на HUD
    }
